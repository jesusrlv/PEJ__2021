          ...
          <div class="table-responsive">
            ...
            <tbody>
              ...
              <?php
                ...
                echo '<td><a href="documentos_generales.php?id='.$row_consulta3['id_ext'].'&id_cat=3"><i class="bi bi-folder"></i></a></td>';
                echo '</tr>';
                ...
                echo '<td><a href="documentos_generales.php?id='.$row_consulta4['id_ext'].'&id_cat=4"><i class="bi bi-folder"></i></a></td>';
                echo '</tr>';
                ...
                echo '<td><a href="documentos_generales.php?id='.$row_consulta5['id_ext'].'&id_cat=5"><i class="bi bi-folder"></i></a></td>';
                echo '</tr>';
                ...
                echo '<td><a href="documentos_generales.php?id='.$row_consulta6['id_ext'].'&id_cat=6"><i class="bi bi-folder"></i></a></td>';
                echo '</tr>';
                ...
                echo '<td><a href="documentos_generales.php?id='.$row_consulta7['id_ext'].'&id_cat=7"><i class="bi bi-folder"></i></a></td>';
                echo '</tr>';
                ...
                echo '<td><a href="documentos_generales.php?id='.$row_consulta8['id_ext'].'&id_cat=8"><i class="bi bi-folder"></i></a></td>';
                echo '</tr>';
                ...
                echo '<td><a href="documentos_generales.php?id='.$row_consulta9['id_ext'].'&id_cat=9"><i class="bi bi-folder"></i></a></td>';
                echo '</tr>';
                ...
                echo '<td><a href="documentos_generales.php?id='.$row_consulta10['id_ext'].'&id_cat=10"><i class="bi bi-folder"></i></a></td>';
                echo '</tr>';
                ...
                echo '<td><a href="documentos_generales.php?id='.$row_consulta11['id_ext'].'&id_cat=11"><i class="bi bi-folder"></i></a></td>';
                echo '</tr>';
                ...
                echo '<td><a href="documentos_generales.php?id='.$row_consulta12['id_ext'].'&id_cat=12"><i class="bi bi-folder"></i></a></td>';
                echo '</tr>';
                ...
                echo '<td><a href="documentos_generales.php?id='.$row_consulta13['id_ext'].'&id_cat=13"><i class="bi bi-folder"></i></a></td>';
                echo '</tr>';
                ...
                echo '<td><a href="documentos_generales.php?id='.$row_consulta14['id_ext'].'&id_cat=14"><i class="bi bi-folder"></i></a></td>';
                echo '</tr>';
                ...
                echo '<td><a href="documentos_generales.php?id='.$row_consulta15['id_ext'].'&id_cat=15"><i class="bi bi-folder"></i></a></td>';
                echo '</tr>';
                ...
                echo '<td><a href="documentos_generales.php?id='.$row_consulta16['id_ext'].'&id_cat=16"><i class="bi bi-folder"></i></a></td>';
                echo '</tr>';
